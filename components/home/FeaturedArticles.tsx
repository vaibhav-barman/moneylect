      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-20 grid gap-8 lg:grid-cols-3">
          ...
          <Link
            ...
            className="group rounded-3xl bg-white p-10 shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-2xl lg:col-span-2"
          >
          ...
          <div className="space-y-6">
            ...
            {featured.slice(1).map((article) => (
              ...
              <Link
                ...
                className="group block rounded-3xl bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-2 hover:shadow-xl"
              >
